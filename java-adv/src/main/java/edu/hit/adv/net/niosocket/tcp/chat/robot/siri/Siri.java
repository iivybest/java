...
public class Siri {
    ...
    private void init() {
        ...
        try {
            ...
            servSocketChannel.socket().bind(new InetSocketAddress(this.port));
    ...
    private void listen() {
        pool.execute(new Monitor(this.selector));
    }
...
//				else // 这里关闭channel，因为客户端已经关闭channel或者异常了
            }
        } catch (Throwable t) {
            t.printStackTrace();
        } finally {
    ...
    private class Monitor implements Runnable {
        ...
        public Monitor(Selector selector) {
