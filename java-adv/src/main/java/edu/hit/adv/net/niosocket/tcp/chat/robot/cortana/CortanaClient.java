package edu.hit.adv.net.niosocket.tcp.chat.robot.cortana;
...
public class CortanaClient implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            CortanaClient c = new CortanaClient();
            c.init();
            new Thread(c).start();
        }
    }
